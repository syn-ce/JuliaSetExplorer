...
export class MandelContext extends FractalContext {
    juliaCenterIndicatorWrapper;
    juliaCenterIndicator;
    juliaCenterIndicatorDimensions;
    currentIndicatorPos; // Used for adjusting when zooming
    indicatorFollowsMouse;
